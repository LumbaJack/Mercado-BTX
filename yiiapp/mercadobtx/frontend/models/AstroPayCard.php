...
class AstroPayCard {
    ...
    //Defined data
    private $base_url = "http://www.astropaycard.com/";
    private $sandbox_base_url = "http://sandbox.astropaycard.com/";
    
    private $validator_url = "verif/validator.php";
    private $transtatus_url = "verif/transtatus.php";
    /*     * *********** ************ ************* */
