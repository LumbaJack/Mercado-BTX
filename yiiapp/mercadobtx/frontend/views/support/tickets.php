...
<div class="row">
	<ul class="nav nav-tabs">
		<li><a href="/<?php echo Yii::t('translation', 'support'); ?>"><?php echo Yii::t('translation', 'support_top_tab_new'); ?></a></li>
		<li class="active"><a href="#"><?php echo Yii::t('translation', 'support_top_tab_open'); ?></a></li>
	</ul>
</div>
